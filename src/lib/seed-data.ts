...
export const BRAND = {
  ...
  description:
    "15 yillik apart-gostinitsa tajribasi bilan O'zbekistonda yetakchi bo'lgan ASIA WAY. Barcha kvartiralar Nest One — mamlakatning eng baland binosi (266.5 metr, 51 qavat) da joylashgan. Aeroport transferidan tortib to barcha xizmatlarni bir joyda taqdim etamiz.",
  building: "Nest One Skyscraper",
  address: "Toshkent shahri, Toshkent City, Botir Zokirov ko'chasi 1A/1",
  coordinates: { lat: 41.304217, lng: 69.417816 },
