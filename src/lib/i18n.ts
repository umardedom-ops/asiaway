...
export interface DashboardDict {
  ...
  journal: { title: string; who: string; purpose: string; when: string; enterName: string; enterPurpose: string; submit: string; subtitle: string };
...
export const D: Record<Lang, DashboardDict> = {
  uz: {
    ...
    journal: { title: "Tizimga kirish", subtitle: "Kim kirayotganini qisqa yozib qo'ying — jurnal shefga boradi.", who: "Ismingiz", purpose: "Maqsad (qisqa)", when: "Vaqt", enterName: "Ism kiriting", enterPurpose: "masalan: bronlarni tekshirish", submit: "Davom etish" },
  ...
  ru: {
    ...
    journal: { title: "Вход в систему", subtitle: "Коротко укажите, кто входит — журнал отправляется шефу.", who: "Ваше имя", purpose: "Цель (коротко)", when: "Время", enterName: "Введите имя", enterPurpose: "например: проверить брони", submit: "Продолжить" },
  ...
  en: {
    ...
    journal: { title: "System entry", subtitle: "Briefly note who is entering — the journal goes to the chief.", who: "Your name", purpose: "Purpose (short)", when: "Time", enterName: "Enter your name", enterPurpose: "e.g.: check bookings", submit: "Continue" },
