...
export interface DashboardDict {
  /** Joriy til kodi — "isRu" satr-taqqoslash hack'lari o'rniga shu ishlatiladi */
  lang: Lang;
  leadStatus: { new: string; contacted: string; waiting: string; won: string; lost: string; closed: string };
  bookingsPage: { title: string; subtitle: string; addManual: string; loadError: string };
  newBookingPage: { placeTitle: string; manualTitle: string; crmClient: string; chooseDates: string; manualSub: string };
  guestsPage: { title: string; subtitle: string; stayingNow: string; placedGuests: string; busyRooms: string; busyToday: string; freeRooms: string; ready: string; arrivingA: string; arrivingB: string; clickPlace: string; roomsStatus: string; currentGuests: string; guest: string; room: string; datesCol: string; amount: string; action: string; noStaying: string; noActiveApt: string; nights: string; busy: string; free: string; dirty: string; floorSuffix: string };
  errors: { selectApt: string; enterName: string; enterPhone: string; enterDates: string; checkoutAfter: string; datesBusy: string; statusUpdate: string; depositUpdate: string; unknown: string };
  sidebar: { panel: string; reception: string; crm: string; apartments: string; kassa: string; finance: string; staff: string; logout: string; system: string; shef: string; menejer: string; finansist: string; targetolog: string };
  journal: { title: string; who: string; role: string; purpose: string; when: string; enterName: string; enterPurpose: string; submit: string; subtitle: string };
...
export const D: Record<Lang, DashboardDict> = {
  uz: {
    lang: "uz",
    leadStatus: { new: "Yangi", contacted: "Suhbatlashildi", waiting: "Kutmoqda", won: "Muvaffaqiyatli", lost: "Rad etdi", closed: "Yopilgan" },
    bookingsPage: { title: "Bronlar boshqaruvi", subtitle: "Saytdagi va qo'lda kiritilgan (Airbnb / Booking / Instagram / WhatsApp) bronlar.", addManual: "Qo'lda bron qo'shish", loadError: "Ma'lumotlarni yuklashda xatolik" },
    newBookingPage: { placeTitle: "Mehmonni joylashtirish", manualTitle: "Qo'lda bron qo'shish", crmClient: "CRM mijozi", chooseDates: "sana va xona tanlang.", manualSub: "Airbnb, Booking, Instagram, WhatsApp yoki telefon orqali kelgan bronni kiriting." },
    guestsPage: { title: "Mehmon joylashtirish", subtitle: "Xonalar bandligi va hozir yashab turgan mehmonlar.", stayingNow: "Hozir turibdi", placedGuests: "Joylashtirilgan mehmonlar", busyRooms: "Band xonalar", busyToday: "Bugun band", freeRooms: "Bo'sh xonalar", ready: "Tayyor", arrivingA: "Bugun", arrivingB: "ta mehmon keladi (hali joylashtirilmagan):", clickPlace: "Bronlar sahifasidan \"Joylashtirish\" bosing.", roomsStatus: "Xonalar holati", currentGuests: "Hozir turgan mehmonlar", guest: "Mehmon", room: "Xona", datesCol: "Keldi — Ketadi", amount: "Summa", action: "Amal", noStaying: "Hozir yashab turgan mehmon yo'q.", noActiveApt: "Faol apartament yo'q.", nights: "kecha", busy: "Band", free: "Bo'sh", dirty: "Tozalash kutilmoqda", floorSuffix: "-qavat" },
    errors: { selectApt: "Apartamentni tanlang", enterName: "Ismni kiriting", enterPhone: "Telefon raqamini kiriting", enterDates: "Sanalarni kiriting", checkoutAfter: "Ketish sanasi kelishdan keyin bo'lsin", datesBusy: "Bu sanalarda apartament allaqachon band", statusUpdate: "Bron holatini yangilashda xatolik", depositUpdate: "Zaklat holatini yangilashda xatolik", unknown: "Xatolik yuz berdi" },
    sidebar: { panel: "Boshqaruv paneli", reception: "Qabul (bron/joylash/xona)", crm: "CRM (Murojaatlar)", apartments: "Apartamentlar", kassa: "Kassa (kirim/chiqim)", finance: "Moliya (P&L)", staff: "Xodimlar", logout: "Chiqish", system: "Tizimda", shef: "Shef", menejer: "Menejer", finansist: "Finansist", targetolog: "Targetolog" },
    journal: { title: "Tizimga kirish", subtitle: "Kim kirayotganini qisqa yozib qo'ying — jurnal shefga boradi.", who: "Ismingiz", role: "Rol", purpose: "Maqsad (qisqa)", when: "Vaqt", enterName: "Ism kiriting", enterPurpose: "masalan: bronlarni tekshirish", submit: "Davom etish" },
  ...
  ru: {
    lang: "ru",
    leadStatus: { new: "Новая", contacted: "Связались", waiting: "Ожидание", won: "Успешно", lost: "Отказ", closed: "Закрыта" },
    bookingsPage: { title: "Управление бронированиями", subtitle: "Бронирования с сайта и внесённые вручную (Airbnb / Booking / Instagram / WhatsApp).", addManual: "Добавить бронь вручную", loadError: "Ошибка загрузки данных" },
    newBookingPage: { placeTitle: "Заселение гостя", manualTitle: "Добавить бронь вручную", crmClient: "Клиент CRM", chooseDates: "выберите даты и номер.", manualSub: "Внесите бронь, поступившую через Airbnb, Booking, Instagram, WhatsApp или по телефону." },
    guestsPage: { title: "Заселение гостей", subtitle: "Занятость номеров и проживающие гости.", stayingNow: "Проживают", placedGuests: "Заселённые гости", busyRooms: "Занятые номера", busyToday: "Заняты сегодня", freeRooms: "Свободные номера", ready: "Готовы к заселению", arrivingA: "Сегодня прибывает", arrivingB: "гостей (ещё не заселены):", clickPlace: "Нажмите «Заселить» на странице бронирований.", roomsStatus: "Статус номеров", currentGuests: "Проживающие гости", guest: "Гость", room: "Номер", datesCol: "Заезд — Выезд", amount: "Сумма", action: "Действие", noStaying: "Сейчас нет проживающих гостей.", noActiveApt: "Нет активных апартаментов.", nights: "ночей", busy: "Занят", free: "Свободен", dirty: "Ожидает уборки", floorSuffix: "-й этаж" },
    errors: { selectApt: "Выберите апартамент", enterName: "Введите имя", enterPhone: "Введите номер телефона", enterDates: "Укажите даты", checkoutAfter: "Дата выезда должна быть позже даты заезда", datesBusy: "Апартамент уже занят на эти даты", statusUpdate: "Ошибка обновления статуса брони", depositUpdate: "Ошибка обновления статуса задатка", unknown: "Произошла ошибка" },
    sidebar: { panel: "Панель управления", reception: "Ресепшн (бронь/заселение/номера)", crm: "CRM (Заявки)", apartments: "Апартаменты", kassa: "Касса (приход/расход)", finance: "Финансы (P&L)", staff: "Сотрудники", logout: "Выйти", system: "В системе", shef: "Шеф", menejer: "Менеджер", finansist: "Финансист", targetolog: "Таргетолог" },
    journal: { title: "Вход в систему", subtitle: "Коротко укажите, кто входит — журнал отправляется шефу.", who: "Ваше имя", role: "Роль", purpose: "Цель (коротко)", when: "Время", enterName: "Введите имя", enterPurpose: "например: проверить брони", submit: "Продолжить" },
  ...
  en: {
    lang: "en",
    leadStatus: { new: "New", contacted: "Contacted", waiting: "Waiting", won: "Won", lost: "Lost", closed: "Closed" },
    bookingsPage: { title: "Booking management", subtitle: "Bookings from the website and entered manually (Airbnb / Booking / Instagram / WhatsApp).", addManual: "Add booking manually", loadError: "Failed to load data" },
    newBookingPage: { placeTitle: "Place a guest", manualTitle: "Add booking manually", crmClient: "CRM client", chooseDates: "choose dates and a room.", manualSub: "Enter a booking that came via Airbnb, Booking, Instagram, WhatsApp or phone." },
    guestsPage: { title: "Guest placement", subtitle: "Room occupancy and current guests.", stayingNow: "Staying now", placedGuests: "Placed guests", busyRooms: "Occupied rooms", busyToday: "Occupied today", freeRooms: "Vacant rooms", ready: "Ready", arrivingA: "Today", arrivingB: "guests arriving (not placed yet):", clickPlace: "Click \"Place\" on the bookings page.", roomsStatus: "Room status", currentGuests: "Current guests", guest: "Guest", room: "Room", datesCol: "Arrived — Leaves", amount: "Amount", action: "Action", noStaying: "No guests staying right now.", noActiveApt: "No active apartments.", nights: "nights", busy: "Occupied", free: "Vacant", dirty: "Awaiting cleaning", floorSuffix: "th floor" },
    errors: { selectApt: "Select an apartment", enterName: "Enter a name", enterPhone: "Enter a phone number", enterDates: "Enter dates", checkoutAfter: "Check-out must be after check-in", datesBusy: "The apartment is already booked for these dates", statusUpdate: "Failed to update booking status", depositUpdate: "Failed to update deposit status", unknown: "An error occurred" },
    sidebar: { panel: "Dashboard", reception: "Reception (bookings/rooms)", crm: "CRM (Leads)", apartments: "Apartments", kassa: "Cash Register", finance: "Finance (P&L)", staff: "Staff", logout: "Logout", system: "Logged in", shef: "Chief", menejer: "Manager", finansist: "Financier", targetolog: "Marketer" },
    journal: { title: "System entry", subtitle: "Briefly note who is entering — the journal goes to the chief.", who: "Your name", role: "Role", purpose: "Purpose (short)", when: "Time", enterName: "Enter your name", enterPurpose: "e.g.: check bookings", submit: "Continue" },
