...
export const T: Record<Lang, Dict> = {
  uz: {
    ...
    about: { kicker: "ASIA WAY HAQIDA", title: "15 Yillik Tajriba. Bitta Mukammal Xizmat.", body: "ASIA WAY — Toshkentdagi premium apartamentlar va shaxsiy xizmatni yagona tizimda birlashtiradi. Aeroportda kutib olishdan tortib, kundalik qulayliklargacha — har bir detal sizning xotirjamligingiz uchun." },
  ...
  ru: {
    ...
    about: { kicker: "О КОМПАНИИ ASIA WAY", title: "15 Лет Опыта. Один Безупречный Сервис.", body: "ASIA WAY объединяет премиальные апартаменты Ташкента и персональный сервис в единую систему. От встречи в аэропорту до ежедневного комфорта — каждая деталь ради вашего спокойствия." },
  ...
  en: {
    ...
    about: { kicker: "ABOUT ASIA WAY", title: "15 Years of Experience. One Flawless Service.", body: "ASIA WAY brings together Tashkent's premium apartments and personal service in a single system. From airport pickup to daily comfort — every detail is for your peace of mind." },
