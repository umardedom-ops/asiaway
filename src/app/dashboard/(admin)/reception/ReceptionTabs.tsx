...
import { Plus, CalendarCheck, BedDouble, DoorClosed, DoorOpen, CalendarDays } from "lucide-react";
...
export default function ReceptionTabs({ bookings, apartments }: { bookings: Row[]; apartments: Row[] }) {
  const [tab, setTab] = useState<"bron" | "joylash" | "xona">("bron");
