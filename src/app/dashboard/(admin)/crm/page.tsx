      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-[#A8A49B] text-[15px] mt-1">
            Sayt, Instagram va boshqa tarmoqlardan kelgan murojaatlarni boshqarish.
          </p>
        </div>
        <div className="bg-[#111417] border border-[rgba(197,164,109,0.14)] px-6 py-3 rounded-xl flex items-center space-x-4">
          <div className="text-center">
            ...
            <div className="text-[11px] font-medium text-[#A8A49B] uppercase tracking-wider">Jami murojaatlar</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-[11px] font-medium text-[#A8A49B] uppercase tracking-wider">Yangilari</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {error ? (
          <div className="p-6 bg-red-950/20 border border-red-900/50 rounded-xl text-red-400 text-center">
            Mijozlarni yuklashda xatolik yuz berdi: {error.message}
            <br/>
            (Supabase bazasida yangi ustunlar qo'shilganini tekshiring)
          </div>
          ...
          <div className="py-20 text-center text-[#A8A49B] bg-[#111417] border border-[rgba(197,164,109,0.14)] rounded-xl">
            ...
            <h3 className="text-[18px] font-heading font-medium text-[#F5F2EB] mb-2">Hozircha murojaatlar yo'q</h3>
            <p>Mijozlar tomonidan qoldirilgan barcha xabarlar shu yerda ko'rinadi.</p>
          </div>
        ) : (
